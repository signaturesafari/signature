        ...
        <div class="container">
          <div class="row mb-5">
            <div class="col-md pt-5">
              <div class="ftco-footer-widget pt-md-5 mb-4">
                <h2 class="ftco-heading-2 text-white">Acerca de</h2>
                ...
                <p class="text-white">Signature Safari es un operador turístico sostenible de propiedad local en Tanzania que ofrece un servicio personalizado e integral a un precio asequible...</p>
            ...
            <div class="col-md pt-5 border-left">
              <div class="ftco-footer-widget pt-md-5 mb-4 ml-md-5">
                <h2 class="ftco-heading-2 text-white">Enlace importante</h2>
                <ul class=" text-white">
                  <li><a href="/es/best-kilimanjaro-trekking-group-join-with-signature-safari" class="py-2 d-block text-white">Unirse a un grupo para el Kilimanjaro</a></li>
                  <li><a href="/es/technical-clothing-for-mount-kilimanjaro-trek" class="py-2 d-block text-white">Ropa técnica para el monte Kilimanjaro</a></li>
                  <li><a href="/es/tanzania-safari-packing-list" class="py-2 d-block text-white">Lista de equipaje para un safari en Tanzania</a></li>
                  <li><a href="/es/technical-clothing-for-mount-kilimanjaro-trek" class="py-2 d-block text-white">Ropa técnica para el Monte Kilimanjaro</a></li>
                  <li><a href="/es/tanzania-safari-packing-list" class="py-2 d-block text-white">Lista de equipaje para un safari en Tanzania</a></li>
                  <li><a href="/es/sustainable-tourism-in-tanzania-with-signature-safari" class="py-2 d-block text-white">Turismo sostenible en Tanzania</a></li>
                  <li><a href="/es/mt-kilimanjaro-and-meru-with-sar" class="py-2 d-block text-white">Servicio de Búsqueda, Rescate y Seguridad del Kilimanjaro</a></li>
                  <li><a href="/es/signature-safari-trustee-board" class="py-2 d-block text-white">Junta directiva</a></li>
                </ul>
              </div>
            </div>
            <div class="col-md pt-5 border-left">
              <div class="ftco-footer-widget pt-md-5 mb-4">
                <h2 class="ftco-heading-2 text-white">Mantente en contacto las 24 horas, los 7 días de la semana.</h2>
          ...
          <form>
            <div class="text-center mb-4 d-block">
              <h2 class="fw-bold text-white">Suscríbete a nuestro boletín</h2>
              <p class="text-white">Mantente al día con nuestras últimas noticias y ofertas.</p>
            </div>
            <div class="row align-items-center justify-content-center">
              <div class="col-6 ">
                <input type="text" class="form-control" placeholder="Nombre de pila" aria-label="First name">
              </div>
              <div class="col-6">
                <input type="text" class="form-control" placeholder="Apellido" aria-label="Last name">
              </div>
              <div class="col-12  d-flex align-items-center justify-content-center mt-4">
              <button class="btn text-white" style="background-color:#f15d30; max-width:100%;">Suscribir</button>
              </div>
            </div>
          </form>
          <div class="row mt-3">
            <div class="col-md-12 col-sm-6 text-center">
              ...
              <p class="text-white text-center">La mayor plataforma de reservas de safaris en África <span class="bolding text-primary"><a class="text-primary" href="https://www.safarigo.com/">www.safarigo.com</a></span><br>
           ...
           <div class="row mt-5 d-flex justify-content-center align-items-center">
             <div class="col-md-12 text-center  d-flex justify-content-center align-items-center">
               <p class="text-white">&copy; 2026 Signature Safari. Todos los derechos reservados.</p>
            </div>
          </div>
        </div>
      </footer>
